# Evgeny Abrosimov — Website Texts
# Все тексты сайта в трёх языках: RU / EN / ES
# После редактирования этого файла — обновите js/content.js (те же тексты, но в формате JS-объекта)
...
| Ключ          | RU                        | EN                        | ES                        |
|---------------|---------------------------|---------------------------|---------------------------|
| brand         | Евгений Абросимов         | Evgeny Abrosimov          | Evgeny Abrosimov          |
| tab.excursions| Экскурсии                 | Day Excursions            | Excursiones               |
| tab.short     | Короткие туры             | Short Tours               | Tours Cortos              |
| tab.long      | Длинные программы         | Long Programs             | Programas Largos          |
| tab.antarctica| Антарктида                | Antarctica                | Antártida                 |
| tab.individual| Индивидуально             | Individual                | Individual                |
...
- Подзаголовок: Более десяти лет я живу в Южной Америке и продолжаю исследовать её каждый день. От улиц Буэнос-Айреса до патагонских треков, от Мачу-Пикчу до Антарктиды — я создаю путешествия, которые помогают увидеть континент глубже, чем это позволяют путеводители.
- Кнопка: Написать мне
...
- Subtítulo: Sudamérica ha sido mi hogar durante más de diez años. Desde Buenos Aires hasta la Patagonia, desde Machu Picchu hasta la Antártida, diseño viajes que permiten descubrir el continente más allá de las guías turísticas.
- Botón: Escríbeme

---

## О СЕБЕ / ABOUT / SOBRE MÍ
...
**RU:** Один из самых впечатляющих природных феноменов планеты. Заходим с аргентинской стороны — ближе и мощнее всего. Звук, брызги, радуги. Это невозможно передать словами.
...
## ДЛИННЫЕ ПРОГРАММЫ / LONG PROGRAMS / PROGRAMAS LARGOS

### 1. Перу / Боливия / Чили
- **EN:** Peru / Bolivia / Chile
- **ES:** Perú / Bolivia / Chile
...
- **EN:** Iguazu Extension
- **ES:** Extensión Iguazú
- Длительность: 2–3 дня / 2–3 days / 2–3 días
...
## АНТАРКТИДА / ANTARCTICA / ANTÁRTIDA (партнёрская программа)

- Фото: images/tours/antarctica/antarctica.jpg

**RU:**
Заголовок: Антарктида — с поддержкой на каждом шаге
Я не веду антарктические экспедиции лично — но помогаю организовать тебе лучшее путешествие на континент. Работаю с проверенными партнёрами: подбираю рейс под твой бюджет и даты, сопровождаю на всех этапах оформления. Антарктида — это сложно, дорого и незабываемо. Я делаю так, чтобы всё прошло без сюрпризов.
Метка: Партнёрская программа

**EN:**
Title: Antarctica — Supported Every Step of the Way
...
**ES:**
Título: Antártida — Con Apoyo en Cada Paso
No lidero expediciones antárticas personalmente — pero te ayudo a organizar el mejor viaje al continente. Trabajo con socios de confianza: seleccionando un crucero que se adapte a tu presupuesto y fechas, acompañándote en cada paso del proceso de reserva. La Antártida es compleja, cara e inolvidable. Me aseguro de que todo salga sin sorpresas.
Etiqueta: Programa de Socios

---

## ИНДИВИДУАЛЬНО / INDIVIDUAL / INDIVIDUAL

- Фото: images/tours/individual/individual-tour.jpg

**RU:**
Заголовок: Ваш маршрут с нуля
Нет программы, которая подходит тебе на 100%? Тогда давай создадим её вместе. Расскажи мне, что тебя зажигает — горы, города, еда, экстрим, уединение, фотография, история — и я составлю маршрут именно под тебя. Сроки и бюджет — твои.

**EN:**
Title: Your Route from Scratch
No program fits you 100%? Let's build one together. Tell me what excites you — mountains, cities, food, adventure, solitude, photography, history — and I'll design a route just for you. Timeline and budget are yours to set.

**ES:**
Título: Tu Ruta desde Cero
¿Ningún programa te encaja al 100%? Construyamos uno juntos. Cuéntame qué te emociona — montañas, ciudades, gastronomía, aventura, soledad, fotografía, historia — y diseñaré una ruta solo para ti. El tiempo y el presupuesto son tuyos.

---

## ОТЗЫВЫ / REVIEWS / TESTIMONIOS
...
### Отзыв 1
**Текст RU:** «С Женей ты перестаёшь быть туристом и становишься путешественником. Разница — огромная.»
**Текст EN:** "With Evgeny you stop being a tourist and become a traveler. The difference is huge."
**Текст ES:** «Con Evgeny dejas de ser turista y te conviertes en viajero. La diferencia es enorme.»
**Автор:** Алексей К. / Alexey K. / Alexey K.
**Город:** Санкт-Петербург / St. Petersburg / San Petersburgo
**Тур:** Перу / Боливия / Чили

### Отзыв 2
**Текст RU:** «Патагония с Евгением — лучшее приключение в жизни. Он знает каждую тропу и каждую хижину.»
**Текст EN:** "Patagonia with Evgeny was the best adventure of my life. He knows every trail and every hut."
**Текст ES:** «La Patagonia con Evgeny fue la mejor aventura de mi vida. Conoce cada sendero y cada cabaña.»
**Автор:** Мария и Дмитрий Л. / Maria & Dmitry L. / Maria y Dmitry L.
**Город:** Москва / Moscow / Moscú
**Тур:** Патагония: треккинг

### Отзыв 3
**Текст RU:** «Всегда на связи, всегда с решением. Когда наш рейс отменили, Женя нашёл выход за два часа.»
**Текст EN:** "Always reachable, always with a solution. When our flight was cancelled, Evgeny found a way out in two hours."
**Текст ES:** «Siempre disponible, siempre con una solución. Cuando cancelaron nuestro vuelo, Evgeny encontró la salida en dos horas.»
**Автор:** Наталья В. / Natalia V. / Natalia V.
**Город:** Екатеринбург / Yekaterinburg / Ekaterimburgo
**Тур:** Короткие туры по Аргентине

### Отзыв 4
**Текст RU:** «Это уже третья поездка с Евгением. И я снова хочу ещё.»
**Текст EN:** "This is my third trip with Evgeny. And I want more."
**Текст ES:** «Este es mi tercer viaje con Evgeny. Y quiero más.»
**Автор:** Игорь Р. / Igor R. / Igor R.
**Город:** Новосибирск / Novosibirsk / Novosibirsk
**Тур:** Буэнос-Айрес + Мендоса

---

## КОНТАКТ / CONTACT / CONTACTO

- RU: Напишите мне / Выберите удобный способ связи — отвечу быстро.
- EN: Get in Touch / Choose the way you prefer — I reply fast.
- ES: Contáctame / Elige cómo prefieres escribirme — respondo rápido.

Кнопки:
- WhatsApp: +54 11 3457 2193
- Telegram: @eabrosimov
- Email: e.i.abrosimov@gmail.com
...
```
images/
├── hero/                        ← СЛАЙДШОУ: 5 фото, меняются автоматически с Ken Burns эффектом
│   ├── hero-1.jpg               ← слайд 1: Евгений с группой / фото на маршруте
│   ├── hero-2.jpg               ← слайд 2: Патагония — Торрес-дель-Пайне или Перито-Морено
│   ├── hero-3.jpg               ← слайд 3: Перу — Мачу-Пикчу или соляное плато Уюни
│   ├── hero-4.jpg               ← слайд 4: Буэнос-Айрес — панорама или яркая улица
│   └── hero-5.jpg               ← слайд 5: любое ваше лучшее фото с маршрутов
│                                   Формат: горизонтальные JPG, мин. 1920×1080px
├── about/
│   └── evgeny-portrait.jpg      ← портрет Евгения, вертикальный, мин. 800×1060px
├── tours/
│   ├── excursions/
│   │   ├── history-ba.jpg           ← исторический центр / улицы Буэнос-Айреса
│   │   ├── recoleta-cemetery.jpg    ← кладбище Реколеты, мавзолеи, Эвита
│   │   ├── football-argentina.jpg   ← стадион / трибуны / матч
│   │   └── tango-show.jpg           ← танго на сцене или милонга
│   ├── short-programs/
│   │   ├── mendoza-wine.jpg         ← виноградники Мендосы / Анды на фоне
│   │   ├── iguazu-falls.jpg         ← водопады Игуасу крупным планом
│   │   ├── salta-northwest.jpg      ← гора семи цветов / Пурмамарка
│   │   └── bariloche-lakes.jpg      ← озеро Науэль-Уапи / горы
│   ├── long-programs/
│   │   ├── peru-bolivia-chile.jpg   ← Мачу-Пикчу или соляное поле Уюни
│   │   ├── patagonia-trekking.jpg   ← Торрес-дель-Пайне (горизонтальный широкий кадр)
│   │   ├── easter-island.jpg        ← статуи моаи
│   │   └── iguazu-extension.jpg     ← водопады с воздуха или лодочный тур
│   ├── antarctica/
│   │   └── antarctica.jpg           ← айсберги / пингвины
│   └── individual/
│       └── individual-tour.jpg      ← Евгений с туристами на маршруте
└── reviews/
    └── (папка для фото клиентов, если захотите добавить)
```

Рекомендуемый формат для карточек туров: JPG горизонтальный, мин. 900×600px.
