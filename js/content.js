    ...
    tours: {
      ...
      short: [
        ...
        },
        {
          ...
          days: [
            "<strong>День 1 (Четверг).</strong> Выезд из Буэнос-Айреса, дорога до ВГБ (~9 часов). По дороге — остановка на обед и короткую прогулку по Росарио — родине Аргентинского флага и Лео Месси.<br><br>Ночуем в Вилья-Хенераль-Бельграно.",
          ...
          faq: [
            {
              ...
              a: "Точных цен ещё нет — ориентироваться можно на ~8–10 тысяч песо за кружку пива. Сувениры (в зависимости от материалов и качества): кружки 50–100 тысяч песо, шляпы 50–100 тысяч песо, костюмы в аренду — пока неизвестно. Цен на 2026 ещё нет."
            },
            {
              q: "Какие исполнители будут играть?",
              a: "Лайн-ап на 2026 ещё не объявлен, но, как правило, речь идёт о популярных исполнителях аргентинского рока. В 2025, к примеру, были Los Pericos, Babasonicos, Abel, а также кавер-группы The Beatles Symphonic Fantasy и EXPERIENCIA QUEEN."
            },
            {
              q: "Где мы будем жить?",
...
const TOUR_DATES = {
  ...
  'patagonia-trekking': [
    { from: '2027-02-15', to: '2027-02-26' },
    { from: '2027-04-04', to: '2027-07-15' }
  ],
  'iguazu-extension': [
