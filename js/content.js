    ...
    tours: {
      ...
      short: [
        ...
        },
        {
          ...
          description: "Полёт из Буэнос-Айреса в Сальту, затем северо-западные высокогорья Аргентины. Деревни, затерянные на высоте 4000+ метров, панорамы, которые меняют представление о масштабах. Караван-сарай вроде Салинас Гранде, где вода и соль хранятся в одном слове, ущелья и тропы. И дух Гуэмеса, который будет сопровождать нас по этому маршруту — от аэропорта его имени до улиц его города и парихи на ужин в его честь.",
    ...
    tours: {
      ...
      short: [
        ...
        { id: "iguazu-short", title: "Iguazu Falls", duration: "2 days", location: "Argentina", description: "One of the most impressive natural phenomena on the planet. We enter from the Argentine side — closest and most powerful. Sound, spray, rainbows. Impossible to describe in words.", image: "images/tours/short-programs/iguazu-falls.jpg",
          "price": "700",
          "showPrefix": true },
        { id: "salta", title: "Highland Argentina", duration: "5 days", location: "Salta, Jujuy", description: "A flight from Buenos Aires to Salta, then into the high-altitude northwest of Argentina. Villages lost at 4000+ meters, panoramas that redefine your sense of scale. Salt flats where water and salt are one word, canyons and mountain trails. The spirit of Guemes will accompany us — from the airport named after him to the streets of his city and the restaurant where we dine in his honour.", image: "images/tours/short-programs/salta-northwest.jpg",
          "price": "550",
          "showPrefix": true },
    ...
    tours: {
      ...
      short: [
        ...
        { id: "iguazu-short", title: "Cataratas del Iguazú", duration: "2 días", location: "Argentina", description: "Uno de los fenómenos naturales más impresionantes del planeta. Entramos por el lado argentino — el más cercano y poderoso. Sonido, salpicaduras, arcoíris. Imposible de describir con palabras.", image: "images/tours/short-programs/iguazu-falls.jpg",
          "price": "700",
          "showPrefix": true },
        { id: "salta", title: "Argentina de Altura", duration: "5 días", location: "Salta, Jujuy", description: "Un vuelo desde Buenos Aires a Salta, luego hacia el noroeste de altura argentina. Pueblos perdidos a 4000+ metros, panoramas que redimensionan la escala. Salares donde agua y sal son una palabra, cañones y senderos de montaña. El espíritu de Güemes nos acompañará — desde el aeropuerto con su nombre hasta las calles de su ciudad y el restaurante donde cenamos en su honor.", image: "images/tours/short-programs/salta-northwest.jpg",
          "price": "550",
          "showPrefix": true },
